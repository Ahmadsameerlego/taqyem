        ...
        <div class="row mt-3 mb-5">
            ...
            <div class="col-md-5 position-relative">
                <div class="inter_action d-flex justify-content-center">
                    <button class="third_btn px-4 btn"  @click="$router.push(`/admin/client/${this.$route.params.id}`)"> السابق </button>

                    <button class="btn main_btn mx-3 px-4 br-20" :disabled="isDisabled" @click="$router.push(`/admin/details/${this.$route.params.id}`)" @click.prevent="storeProucts"> 
                        التالي
