                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" name="" disabled id="" v-model="receiver_email">

                            </div>
                        </div>

                        <div class="d-flex justify-content-end">
                            <button class="btn main_btn" @click="$router.push(`/showCompleteOrder/${this.$route.params.id}`)" @click.prevent="storeClient" :disabled="isDisabled"> 
                                التالي
